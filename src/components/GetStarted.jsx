...
const GetStarted = () => {
  return (
    <Link
      to="/recipes"
      className="flex justify-center items-center w-[140px] h-[140px] rounded-full bg-blue-gradient p-[2px] cursor-pointer hover:scale-105 ease-in-out duration-500"
    >
