...
const Footer = () => (
  <section className="flex items-center justify-center flex-col sm:py-16 py-6">
    <div className="flex items-start justify-center md:flex-row flex-col mb-8 w-full">
      <div className="flex-1 flex flex-col justify-start mr-10">
        ...
        <p className="font-poppins font-normal text-dimWhite text-[18px] leading-[30.8px] mt-4 max-w-[310px]">
          Authentic Moroccan recipes, guides, and community—savor the taste at
          home!
        </p>
      </div>
    ...
    <div className="flex w-full justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3e45]">
      <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-dimWhite">
        2023 Marokitchen. All Rights Reserved
      </p>
